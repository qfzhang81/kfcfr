...
//    protected RwRoundRobinRoutingDataSource initDataSource() {
//        Map<Object, Object> targetDataSources = new HashMap<>();
//        targetDataSources.put(RwDataSourceType.writer.getType(), dataSourceWriter);
//        if (dataSourceReaderList != null) {
//            int size = 0;
//            for (DataSource ds : dataSourceReaderList) {
//                size++;
...
//        dataSource.setReaderSize(dataSourceReaderList.size());
//        return dataSource;
//    }

    protected void initDataSource(DataSource dataSourceWriter, DataSource... dataSourceReaders) {
        Map<Object, Object> targetDataSources = new HashMap<>();
        targetDataSources.put(RwDataSourceType.writer.getType(), dataSourceWriter);
