...
public class RabbitMessageHelper {
    ...
    public static byte[] convertBodyToBytes(String body, Charset charset, Charset defaultCharset) {
    ...
    public static String convertBodyToString(byte[] body, Charset charset, Charset defaultCharset) {
        Charset useCharset = charset;
        if (useCharset == null) useCharset = defaultCharset;
        if (useCharset == null) useCharset = DEFAULT_CHARSET;
